DROP TABLE IF EXISTS DataBankDBUI.dbo.customer_transactions;
CREATE TABLE DataBankDBUI.dbo.customer_transactions (
	customer_id INT,
	txn_date DATE,
	txn_type VARCHAR(10),
	txn_amount INT
);
INSERT INTO DataBankDBUI.dbo.customer_transactions
...
DROP TABLE IF EXISTS DataBankDBUI.dbo.customer_nodes;
CREATE TABLE DataBankDBUI.dbo.customer_nodes (
	customer_id INT,
	region_id INT,
	node_id INT,
	start_date DATE,
...
INSERT INTO DataBankDBUI.dbo.customer_nodes
...
DROP TABLE IF EXISTS DataBankDBUI.dbo.regions;
CREATE TABLE DataBankDBUI.dbo.regions (
	region_id INT NOT NULL,
	region_name VARCHAR(9)
);
INSERT INTO DataBankDBUI.dbo.regions
...
ALTER TABLE DataBankDBUI.dbo.regions
ADD CONSTRAINT PK_regions PRIMARY KEY (region_id);

ALTER TABLE DataBankDBUI.dbo.customer_nodes
ADD CONSTRAINT FK_customer_nodes_regions_region_id FOREIGN KEY (region_id) REFERENCES regions(region_id);