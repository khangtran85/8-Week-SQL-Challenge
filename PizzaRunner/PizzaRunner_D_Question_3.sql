...
DROP TABLE IF EXISTS PizzaRunnerDBUI.dbo.runner_ratings;
...
INTO PizzaRunnerDBUI.dbo.runner_ratings
...
BEGIN
	ALTER TABLE PizzaRunnerDBUI.dbo.runner_ratings
	DROP COLUMN rating
END;
...
WHILE @Counter <= @RowCount
	BEGIN
		UPDATE PizzaRunnerDBUI.dbo.runner_ratings
